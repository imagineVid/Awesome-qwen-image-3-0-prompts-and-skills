...
> Oficjalne przykłady Qwen Image 3.0 odtworzone jako wielokrotnego użytku angielskie prompty produkcyjne z weryfikowalnymi mediami i jasnym autorstwem.
...
- [Przewodnik po modelu](#model-guide)
- [Indeks przepływów pracy](#workflow-index)
- [Zweryfikowane oficjalne przykłady](#verified-showcase-cases)
- [Współtwórz](#contribute)
- [Licencja i autorstwo](#license-and-attribution)

<a id="model-guide"></a>

## Przewodnik po modelu

Qwen Image 3.0 to trzecia generacja modelu tworzenia i edycji obrazów zespołu Qwen. Oficjalna premiera podkreśla bogactwo treści, autentyczne szczegóły i głęboką wiedzę. Qwen deklaruje instrukcje do 4,5K tokenów, tekst o wielkości 10 pikseli, natywne renderowanie w 12 językach, ponad 100 stylów artystycznych, złożone interfejsy i edycję referencyjną. Kolekcja przekształca oficjalne demonstracje w kompletne angielskie prompty produkcyjne, oddzielając deklaracje producenta od niezależnych wyników.

> Treść promptów pozostaje po angielsku, aby wszystkie języki korzystały z jednej odtwarzalnej wersji wzorcowej.

### Co sprawdza ta kolekcja

- Gęste publikacje wielopanelowe i długie instrukcje strukturalne
- Drobny tekst, wzory, adnotacje i typografia wielojęzyczna
- Realistyczne faktury skóry, włosów, papieru, tkanin i materiałów
- Edycja referencyjna, renowacja, symulacja interfejsów i grafiki wiedzy
...
**[Twórz obrazy w ImagineVid](https://imaginevid.io/pl/ai-image-generator)**

<a id="workflow-index"></a>

## Indeks przepływów pracy

- **Rozbudowane projektowanie informacji**
- **Typografia i publikacja**
- **Interfejsy i wiedza o świecie**
- **Fotorealizm i szczegóły materiałów**
- **Edycja i renowacja referencyjna**
...
### 1. Atlas dziewięciu dziedzin wiedzy w jednym obrazie

Plansza 3×3 sprawdzająca długie instrukcje, separację znaczeń, wzory, diagramy i czytelny tekst dwujęzyczny.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Atlas dziewięciu dziedzin wiedzy w jednym obrazie"></td>
</tr></table>

#### Dowód źródłowy

- **Twórca:** [Qwen Team](https://qwen.ai/)
- **Oficjalny przykład:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Opublikowano:** 2026-07-21
- **Kategoria:** Rozbudowane projektowanie informacji
...
### 2. Zagnieżdżone interfejsy programów

Cztery rozpoznawalne przestrzenie robocze w jednej kompozycji z zachowaniem hierarchii.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Zagnieżdżone interfejsy programów"></td>
</tr></table>
...
- **Oficjalny przykład:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Opublikowano:** 2026-07-21
- **Kategoria:** Interfejsy i wiedza o świecie
- **Wymaga obrazów referencyjnych:** Nie
...
### 3. Przewodnik badawczy po rekinie wielorybim

Gęsta grafika morska łącząca anatomię, migrację, skalę, dietę i ochronę.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Przewodnik badawczy po rekinie wielorybim"></td>
</tr></table>
...
### 4. Precyzyjnie złożony artykuł z geometrii algebraicznej

Test publikacyjny struktury matematycznej, zapisu podobnego do LaTeX, twierdzeń i drobnego tekstu.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Precyzyjnie złożony artykuł z geometrii algebraicznej"></td>
</tr></table>
...
### 5. Pierwsza strona niedzielnej gazety

Kompozycja druku łącząca długi tekst, zdjęcia, kolumny, podpisy i realistyczny papier.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Pierwsza strona niedzielnej gazety"></td>
</tr></table>
...
### 6. Naturalne odręczne notatki do nauki

Edycja referencyjna dodająca wiarygodne zapiski bez zmiany strony, druku, światła i perspektywy.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Naturalne odręczne notatki do nauki"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Naturalne odręczne notatki do nauki"></td>
</tr></table>
...
### 7. Nieretuszowany portret przy oknie

Portret redakcyjny skupiony na porach, delikatnych włosach, wilgotnych oczach, stonowanej barwie i naturalnej optyce.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Nieretuszowany portret przy oknie"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Nieretuszowany portret przy oknie"></td>
</tr></table>
...
### 8. Konserwatorska renowacja tuszowego obrazu orłów

Odtworzenie uszkodzonego papieru i pędzla z zachowaniem wieku, kompozycji i rytmu tuszu.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Konserwatorska renowacja tuszowego obrazu orłów"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Konserwatorska renowacja tuszowego obrazu orłów"></td>
</tr></table>
...
### 9. Seria plakatów kulturalnych w trzech językach

Wspólna identyfikacja testująca naturalną typografię japońską, koreańską i hiszpańską.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Seria plakatów kulturalnych w trzech językach"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Seria plakatów kulturalnych w trzech językach"></td>
</tr></table>
...
### 10. Reżyserka sprzedaży na żywo

Interfejs produkcyjny porządkujący wideo, produkty, moderację, zapasy i wyniki zgodnie z rzeczywistą pracą.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Reżyserka sprzedaży na żywo"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Reżyserka sprzedaży na żywo"></td>
</tr></table>
...
### 11. Od zdjęcia owada do planszy badawczej

Edycja naukowa zachowująca okaz i dodająca taksonomię, anatomię, powiększenia oraz skalę.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="Od zdjęcia owada do planszy badawczej"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="Od zdjęcia owada do planszy badawczej"></td>
</tr></table>
...
### 12. Transmisja historii sztuki między epokami

Scena edukacyjna łącząca wiedzę historyczną, nowoczesny interfejs i jasne oznaczenie fikcji.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Transmisja historii sztuki między epokami"></td>
</tr></table>
...
### 13. Dwupanelowa czarno-biała manga z dokładnym dialogiem japońskim

Rekonstrukcja produkcyjna oparta na przykładzie społeczności, testująca ciągłość kadrów, oszczędną kreskę, pionowy tekst i precyzyjne dymki.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Dwupanelowa czarno-biała manga z dokładnym dialogiem japońskim"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Dwupanelowa czarno-biała manga z dokładnym dialogiem japońskim"></td>
</tr></table>

#### Dowód źródłowy

- **Twórca:** [Yasun](https://x.com/yasun_ai)
...
### 15. Zagniezdzony edytor kodu i plakat w czacie

Warstwowy prompt interfejsu do testowania czytelnego tekstu UI, glebi przestrzennej i generowania plakatu wewnatrz czatu.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-ydubbcAAPs_n.png" width="100%" alt="Zagniezdzony edytor kodu i plakat w czacie"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-yelfakAAjQN9.png" width="100%" alt="Zagniezdzony edytor kodu i plakat w czacie"></td>
</tr></table>

#### Dowód źródłowy

- **Twórca:** [比特小师妹｜KiKi](https://x.com/bit_sister)
- **Oficjalny przykład:** [Qwen Image 3.0](https://x.com/bit_sister/status/2080577815376957798)
...
### 16. Test tekstu na deszczowej ulicy Stambulu

Wielojezyczna scena uliczna sprawdzajaca tureckie znaki, pismo reczne, mokre odbicia, naturalny tlum i realistyczna anatomie.
...
<table><tr>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rO4cX0AAR78e.jpg" width="100%" alt="Test tekstu na deszczowej ulicy Stambulu"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rP9RWAAAst62.jpg" width="100%" alt="Test tekstu na deszczowej ulicy Stambulu"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rQ5tW0AAaIuX.jpg" width="100%" alt="Test tekstu na deszczowej ulicy Stambulu"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rRfiW4AA_Eje.jpg" width="100%" alt="Test tekstu na deszczowej ulicy Stambulu"></td>
</tr></table>

#### Dowód źródłowy

- **Twórca:** [Ozan Sihay](https://x.com/ozansihay)
- **Oficjalny przykład:** [Qwen Image 3.0](https://x.com/ozansihay/status/2080218385607008613)
...
### 17. Vintage portret coquette z referencja

Prompt portretowy prowadzony referencja, skupiony na zachowaniu tozsamosci, realistycznej skorze, stylu starego rozu i ciasnym kadrze editorialowym.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5YtbNaYAAOIFV.jpg" width="100%" alt="Vintage portret coquette z referencja"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5Yum6bAAAIApb.jpg" width="100%" alt="Vintage portret coquette z referencja"></td>
</tr></table>

#### Dowód źródłowy

- **Twórca:** [Rich · Atom Tan Studio](https://x.com/atomtanstudio)
...
Przesyłaj tylko przypadki wyraźnie wskazujące Qwen Image 3.0, z użytecznym promptem, oryginalnym źródłem i możliwym do sprawdzenia rezultatem.

[Prześlij zweryfikowany prompt](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Licencja i autorstwo

Kod, rekonstrukcje promptów, tłumaczenia i tekst redakcyjny ImagineVid są objęte licencją CC BY 4.0. Oficjalne przykłady i media Qwen pozostają własnością ich właścicieli i prowadzą do pierwotnego ogłoszenia. Qwen i Alibaba są znakami towarowymi ich właścicieli. Ta niezależna kolekcja nie jest z nimi powiązana ani przez nich wspierana.

Opracowanie: Rowan Hale dla ImagineVid.
