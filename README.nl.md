...
> Officiële Qwen Image 3.0-voorbeelden herbouwd als herbruikbare Engelse productieprompts, met controleerbare media en transparante bronvermelding.
...
- [Modelgids](#model-guide)
- [Workflowoverzicht](#workflow-index)
- [Geverifieerde officiële voorbeelden](#verified-showcase-cases)
- [Bijdragen](#contribute)
- [Licentie en bronvermelding](#license-and-attribution)

<a id="model-guide"></a>

## Modelgids

Qwen Image 3.0 is de derde generatie van het beeldgeneratie- en bewerkingsmodel van het Qwen-team. De officiële introductie draait om rijke inhoud, authentieke details en diepgaande kennis. Qwen noemt instructies tot 4,5K tokens, tekst van 10 pixels, native weergave in 12 talen, meer dan 100 kunststijlen, complexe interfaces en referentiebewerking. Deze collectie bouwt de officiële voorbeelden om tot volledige Engelse productieprompts en presenteert de mogelijkheden als claims van de maker, niet als onafhankelijke testresultaten.

> De prompts blijven Engels, zodat elke taal dezelfde reproduceerbare standaardversie gebruikt.

### Wat deze collectie test

- Dichte publicaties met meerdere panelen en lange gestructureerde instructies
- Kleine tekst, formules, aantekeningen en meertalige typografie
- Realistische texturen van huid, haar, papier, stof en materialen
- Referentiebewerking, restauratie, interfacesimulatie en kennisgraphics
...
**[Maak afbeeldingen in ImagineVid](https://imaginevid.io/nl/ai-image-generator)**

<a id="workflow-index"></a>

## Workflowoverzicht

- **Informatiedesign in lange vorm**
- **Typografie en publicatie**
- **Interfaces en wereldkennis**
- **Fotorealisme en materiaaldetail**
- **Referentiebewerking en restauratie**

<a id="verified-showcase-cases"></a>

## Geverifieerde officiële voorbeelden

| Status van de collectie | 19 geverifieerde voorbeelden |
|---|---:|
| Laatst gegenereerd | 2026-07-21 |

### 1. Kennisatlas van negen domeinen in één generatie

Een educatief 3×3-overzicht voor lange instructies, semantische scheiding, formules, diagrammen en leesbare tweetalige tekst.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Kennisatlas van negen domeinen in één generatie"></td>
</tr></table>

#### Bronbewijs

- **Maker:** [Qwen Team](https://qwen.ai/)
- **Officiële demonstratie:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Gepubliceerd:** 2026-07-21
- **Categorie:** Informatiedesign in lange vorm
...
### 2. Geneste software-interfaces

Vier herkenbare werkruimten in één doorlopende compositie met behoud van hun hiërarchie.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Geneste software-interfaces"></td>
</tr></table>
...
- **Officiële demonstratie:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Gepubliceerd:** 2026-07-21
- **Categorie:** Interfaces en wereldkennis
- **Referentiebeelden vereist:** Nee
...
### 3. Onderzoeksgids over de walvishaai

Een dichte mariene infographic over anatomie, migratie, schaal, voeding en bescherming.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Onderzoeksgids over de walvishaai"></td>
</tr></table>
...
### 4. Nauwkeurig gezet artikel over algebraïsche meetkunde

Een publicatietest voor wiskundige structuur, LaTeX-achtige notatie, stellingen en kleine tekst.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Nauwkeurig gezet artikel over algebraïsche meetkunde"></td>
</tr></table>
...
### 5. Voorpagina van een zondagskrant

Een drukwerkcompositie met lange tekst, foto's, kolommen, bijschriften en realistische papierstructuur.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Voorpagina van een zondagskrant"></td>
</tr></table>
...
### 6. Natuurlijke handgeschreven studienotities

Referentiebewerking met geloofwaardige aantekeningen zonder pagina, drukwerk, licht of perspectief te wijzigen.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Natuurlijke handgeschreven studienotities"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Natuurlijke handgeschreven studienotities"></td>
</tr></table>
...
- **Officiële demonstratie:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Gepubliceerd:** 2026-07-21
- **Categorie:** Referentiebewerking en restauratie
- **Referentiebeelden vereist:** Ja

**[Gebruik deze prompt in ImagineVid](https://imaginevid.io/nl/ai-image-generator)**

---

### 7. Onbewerkt portret bij het raam

Een redactioneel portret met poriën, fijne haren, vochtige ogen, ingetogen kleur en geloofwaardige optiek.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Onbewerkt portret bij het raam"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Onbewerkt portret bij het raam"></td>
</tr></table>
...
### 8. Conserverende restauratie van een inkttekening met arenden

Herstel van beschadigd papier en penseelwerk met behoud van ouderdom, compositie en inkritme.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Conserverende restauratie van een inkttekening met arenden"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Conserverende restauratie van een inkttekening met arenden"></td>
</tr></table>
...
### 9. Culturele posterserie in drie talen

Eén identiteit die natuurlijke Japanse, Koreaanse en Spaanse typografie beproeft.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Culturele posterserie in drie talen"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Culturele posterserie in drie talen"></td>
</tr></table>
...
### 10. Regiekamer voor live commerce

Een productie-interface voor video, producten, moderatie, voorraad en prestaties volgens echte werkprioriteiten.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Regiekamer voor live commerce"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Regiekamer voor live commerce"></td>
</tr></table>
...
### 11. Van insectenfoto naar onderzoeksplaat

Wetenschappelijke bewerking met behoud van het specimen en toevoeging van taxonomie, anatomie, details en schaal.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="Van insectenfoto naar onderzoeksplaat"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="Van insectenfoto naar onderzoeksplaat"></td>
</tr></table>
...
### 12. Kunstgeschiedenisstream door de eeuwen heen

Een educatieve scène met historische kennis, moderne interface en duidelijke fictievermelding.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Kunstgeschiedenisstream door de eeuwen heen"></td>
</tr></table>
...
### 13. Tweedelige zwart-witmanga met exacte Japanse dialoog

Een op communitybewijs gebaseerde productiereconstructie voor paneelcontinuïteit, sobere lijnvoering, verticale tekst en precieze tekstballonnen.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Tweedelige zwart-witmanga met exacte Japanse dialoog"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Tweedelige zwart-witmanga met exacte Japanse dialoog"></td>
</tr></table>

#### Bronbewijs

- **Maker:** [Yasun](https://x.com/yasun_ai)
...
### 15. Geneste code-editor en chatposterworkflow

Een gelaagde interfaceprompt die leesbare UI-tekst, ruimtelijke diepte en postercreatie binnen een chatwerkruimte test.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-ydubbcAAPs_n.png" width="100%" alt="Geneste code-editor en chatposterworkflow"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-yelfakAAjQN9.png" width="100%" alt="Geneste code-editor en chatposterworkflow"></td>
</tr></table>

#### Bronbewijs

- **Maker:** [比特小师妹｜KiKi](https://x.com/bit_sister)
- **Officiële demonstratie:** [Qwen Image 3.0](https://x.com/bit_sister/status/2080577815376957798)
...
### 17. Vintage coquette referentieportret close-up

Een referentiegestuurde beautyprompt rond identiteitsbehoud, realistische huidtextuur, oudroze styling en nauwe editoriale kadrering.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5YtbNaYAAOIFV.jpg" width="100%" alt="Vintage coquette referentieportret close-up"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5Yum6bAAAIApb.jpg" width="100%" alt="Vintage coquette referentieportret close-up"></td>
</tr></table>

#### Bronbewijs

- **Maker:** [Rich · Atom Tan Studio](https://x.com/atomtanstudio)
- **Officiële demonstratie:** [Qwen Image 3.0](https://x.com/atomtanstudio/status/2080197723429711958)
...
### 18. Identiteitsbewerking van een rebelse rockster

Een brononderbouwde case rond “Identiteitsbewerking van een rebelse rockster”, met herbruikbare instructies en controleerbare resultaatmedia.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vClvW4AA8M-H.jpg" width="100%" alt="Identiteitsbewerking van een rebelse rockster"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vDMGWoAAHCnh.jpg" width="100%" alt="Identiteitsbewerking van een rebelse rockster"></td>
</tr></table>

#### Bronbewijs

- **Maker:** [Ash](https://x.com/asheem01)
- **Officiële demonstratie:** [Qwen Image 3.0](https://x.com/asheem01/status/2079940712322199938)
- **Gepubliceerd:** 2026-07-22
- **Categorie:** Referentiebewerking en restauratie
- **Referentiebeelden vereist:** Ja
...
### 19. Portret in Song-stijl met verfijnde inkt en fotografisch licht

Een brononderbouwd Qwen Image 3-portret met Song-geïnspireerde compositie, leesbare kalligrafie, zijde-textuur en ingetogen editorial kleuren.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN1YAvkagAAoW3N.jpg" width="100%" alt="Portret in Song-stijl met verfijnde inkt en fotografisch licht"></td>
</tr></table>

#### Bronbewijs

- **Maker:** [岚叔](https://x.com/LufzzLiz)
- **Officiële demonstratie:** [Qwen Image 3.0](https://x.com/LufzzLiz/status/2079925505634234856)
- **Gepubliceerd:** 2026-07-22
- **Categorie:** Referentiebewerking en restauratie
- **Referentiebeelden vereist:** Nee
...
### 20. Tijdschriftcover met regendruppels en een glazen schaakpaard

Een brononderbouwde Qwen Image 3-publicatiecase met exacte covertypografie, reflecterend glas, een transparant object en nachtelijk editorial licht.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN2kFdfWsAEQTO-.jpg" width="100%" alt="Tijdschriftcover met regendruppels en een glazen schaakpaard"></td>
</tr></table>

#### Bronbewijs

- **Maker:** [Ivana](https://x.com/ivanainai)
- **Officiële demonstratie:** [Qwen Image 3.0](https://x.com/ivanainai/status/2080000842959106328)
- **Gepubliceerd:** 2026-07-22
- **Categorie:** Typografie en publicatie
- **Referentiebeelden vereist:** Ja
...
Dien alleen voorbeelden in die Qwen Image 3.0 expliciet noemen, een herbruikbare prompt, de oorspronkelijke bron en controleerbare resultaten bevatten.

[Geverifieerde prompt insturen](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Licentie en bronvermelding

Door ImagineVid gemaakte code, promptreconstructies, vertalingen en redactionele tekst vallen onder CC BY 4.0. Officiële Qwen-voorbeelden en media blijven eigendom van hun rechthebbenden en linken naar de oorspronkelijke aankondiging. Qwen en Alibaba zijn merken van hun eigenaren. Deze onafhankelijke collectie is niet aan hen verbonden of door hen goedgekeurd.

Samengesteld door Rowan Hale voor ImagineVid.
