...
> Casos oficiais do Qwen Image 3.0 reconstruídos como prompts de produção reutilizáveis em inglês, com mídia verificável e atribuição transparente.
...
- [Guia do modelo](#model-guide)
- [Índice de fluxos de trabalho](#workflow-index)
- [Casos oficiais verificados](#verified-showcase-cases)
- [Contribuir](#contribute)
- [Licença e atribuição](#license-and-attribution)

<a id="model-guide"></a>

## Guia do modelo

Qwen Image 3.0 é a terceira geração do modelo de geração e edição de imagens da equipe Qwen. O lançamento oficial o organiza em torno de conteúdo rico, detalhes autênticos e conhecimento profundo. A Qwen declara instruções de até 4,5K tokens, texto com 10 pixels, renderização nativa em 12 idiomas, mais de 100 estilos artísticos, interfaces complexas e edição por referência. Esta coleção transforma as demonstrações oficiais em prompts completos de produção em inglês e trata essas capacidades como afirmações do fabricante, não como resultados independentes.

> Os prompts permanecem em inglês para que todos os idiomas compartilhem uma versão canônica reproduzível.

### O que esta coleção testa

- Publicações densas com vários painéis e instruções longas
- Texto pequeno, fórmulas, anotações e tipografia multilíngue
- Texturas realistas de pele, cabelo, papel, tecido e materiais
- Edição por referência, restauração, simulação de interfaces e gráficos de conhecimento
...
**[Criar imagens no ImagineVid](https://imaginevid.io/pt/ai-image-generator)**

<a id="workflow-index"></a>

## Índice de fluxos de trabalho

- **Design de informação em formato longo**
- **Tipografia e publicação**
- **Interfaces e conhecimento de mundo**
- **Fotorrealismo e detalhes de materiais**
- **Edição e restauração por referência**
...
### 1. Atlas de nove áreas do conhecimento em uma geração

Uma prancha educacional 3×3 que testa instruções longas, separação semântica, fórmulas, diagramas e texto bilíngue.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Atlas de nove áreas do conhecimento em uma geração"></td>
</tr></table>

#### Evidência da fonte

- **Criador:** [Qwen Team](https://qwen.ai/)
- **Demonstração oficial:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publicado:** 2026-07-21
- **Categoria:** Design de informação em formato longo
...
### 2. Interfaces de software aninhadas

Quatro ambientes reconhecíveis em uma composição contínua que preserva a hierarquia.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Interfaces de software aninhadas"></td>
</tr></table>
...
- **Demonstração oficial:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publicado:** 2026-07-21
- **Categoria:** Interfaces e conhecimento de mundo
- **Exige imagens de referência:** Não
...
### 3. Guia científico do tubarão-baleia

Uma infografia marinha densa que reúne anatomia, migração, escala, dieta e conservação.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Guia científico do tubarão-baleia"></td>
</tr></table>
...
### 4. Artigo de geometria algébrica com composição precisa

Um teste editorial de estrutura matemática, notação tipo LaTeX, hierarquia de teoremas e texto pequeno.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Artigo de geometria algébrica com composição precisa"></td>
</tr></table>
...
### 5. Capa de um jornal de domingo

Composição impressa que coordena texto longo, fotos, colunas, legendas e textura realista de papel.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Capa de um jornal de domingo"></td>
</tr></table>
...
### 6. Anotações de estudo manuscritas

Edição com referência que adiciona notas naturais sem alterar a página, o texto, a luz ou a perspectiva.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Anotações de estudo manuscritas"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Anotações de estudo manuscritas"></td>
</tr></table>
...
### 7. Retrato à janela sem retoque

Retrato editorial voltado a poros, fios finos, olhos úmidos, cor contida e óptica convincente.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Retrato à janela sem retoque"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Retrato à janela sem retoque"></td>
</tr></table>
...
### 8. Restauração de pintura de águias em nanquim

Reconstrução de papel e pinceladas danificados preservando idade, composição e ritmo da tinta.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Restauração de pintura de águias em nanquim"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Restauração de pintura de águias em nanquim"></td>
</tr></table>
...
### 9. Série de cartazes culturais em três idiomas

Uma identidade comum que testa tipografia nativa em japonês, coreano e espanhol.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Série de cartazes culturais em três idiomas"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Série de cartazes culturais em três idiomas"></td>
</tr></table>
...
### 10. Sala de controle de comércio ao vivo

Interface de produção que organiza vídeo, produtos, moderação, estoque e desempenho segundo a operação real.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Sala de controle de comércio ao vivo"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Sala de controle de comércio ao vivo"></td>
</tr></table>
...
### 11. De foto de inseto a prancha científica

Edição que preserva o espécime e acrescenta taxonomia, anatomia, ampliações e escala.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="De foto de inseto a prancha científica"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="De foto de inseto a prancha científica"></td>
</tr></table>
...
### 12. Transmissão de história da arte entre épocas

Cena educativa que combina conhecimento histórico, interface moderna e indicação explícita de ficção.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Transmissão de história da arte entre épocas"></td>
</tr></table>
...
### 13. Mangá monocromático em dois painéis com diálogo japonês exato

Reconstrução de produção baseada num caso da comunidade para testar continuidade, traço contido, texto vertical e balões precisos.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Mangá monocromático em dois painéis com diálogo japonês exato"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Mangá monocromático em dois painéis com diálogo japonês exato"></td>
</tr></table>

#### Evidência da fonte

- **Criador:** [Yasun](https://x.com/yasun_ai)
...
### 15. Editor de codigo aninhado e poster no chat

Prompt de interface em camadas para testar texto de UI legivel, profundidade espacial e geracao de poster dentro de um chat.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-ydubbcAAPs_n.png" width="100%" alt="Editor de codigo aninhado e poster no chat"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-yelfakAAjQN9.png" width="100%" alt="Editor de codigo aninhado e poster no chat"></td>
</tr></table>

#### Evidência da fonte

- **Criador:** [比特小师妹｜KiKi](https://x.com/bit_sister)
- **Demonstração oficial:** [Qwen Image 3.0](https://x.com/bit_sister/status/2080577815376957798)
...
### 17. Retrato coquette vintage com referencia

Prompt de retrato guiado por referencia focado em identidade, textura real de pele, estilo rosa antigo e enquadramento editorial fechado.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5YtbNaYAAOIFV.jpg" width="100%" alt="Retrato coquette vintage com referencia"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5Yum6bAAAIApb.jpg" width="100%" alt="Retrato coquette vintage com referencia"></td>
</tr></table>

#### Evidência da fonte

- **Criador:** [Rich · Atom Tan Studio](https://x.com/atomtanstudio)
- **Demonstração oficial:** [Qwen Image 3.0](https://x.com/atomtanstudio/status/2080197723429711958)
...
### 18. Edição de identidade de uma estrela de rock rebelde

Um caso baseado em fontes que explora “Edição de identidade de uma estrela de rock rebelde”, com instruções reutilizáveis e mídia de resultado verificável.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vClvW4AA8M-H.jpg" width="100%" alt="Edição de identidade de uma estrela de rock rebelde"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vDMGWoAAHCnh.jpg" width="100%" alt="Edição de identidade de uma estrela de rock rebelde"></td>
</tr></table>

#### Evidência da fonte

- **Criador:** [Ash](https://x.com/asheem01)
- **Demonstração oficial:** [Qwen Image 3.0](https://x.com/asheem01/status/2079940712322199938)
- **Publicado:** 2026-07-22
- **Categoria:** Edição e restauração por referência
- **Exige imagens de referência:** Sim
...
### 19. Retrato de inspiração Song com tinta refinada e luz fotográfica

Um retrato do Qwen Image 3 baseado em fonte que combina composição inspirada na dinastia Song, caligrafia legível, textura de seda e cor editorial contida.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN1YAvkagAAoW3N.jpg" width="100%" alt="Retrato de inspiração Song com tinta refinada e luz fotográfica"></td>
</tr></table>

#### Evidência da fonte

- **Criador:** [岚叔](https://x.com/LufzzLiz)
- **Demonstração oficial:** [Qwen Image 3.0](https://x.com/LufzzLiz/status/2079925505634234856)
- **Publicado:** 2026-07-22
- **Categoria:** Edição e restauração por referência
- **Exige imagens de referência:** Não
...
Envie apenas casos que identifiquem Qwen Image 3.0, incluam um prompt reutilizável, preservem a fonte canônica e apresentem resultados verificáveis.

[Enviar um prompt verificado](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Licença e atribuição

Código, reconstruções de prompts, traduções e textos editoriais da ImagineVid são licenciados sob CC BY 4.0. Exemplos e mídias oficiais do Qwen pertencem aos seus titulares e apontam para o anúncio original. Qwen e Alibaba são marcas de seus proprietários. Esta coleção independente não é afiliada nem endossada por eles.

Curadoria de Rowan Hale para a ImagineVid.
