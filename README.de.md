...
> Offizielle Qwen-Image-3.0-Beispiele als wiederverwendbare englische Produktionsprompts mit prüfbaren Medien und transparenter Quellenangabe.
...
- [Modellübersicht](#model-guide)
- [Workflow-Übersicht](#workflow-index)
- [Geprüfte offizielle Beispiele](#verified-showcase-cases)
- [Mitwirken](#contribute)
- [Lizenz und Quellenangabe](#license-and-attribution)

<a id="model-guide"></a>

## Modellübersicht

Qwen Image 3.0 ist die dritte Generation des Bildgenerierungs- und Bearbeitungsmodells des Qwen-Teams. Die offizielle Vorstellung betont reichhaltige Inhalte, authentische Details und tiefes Wissen. Qwen nennt Anweisungen bis 4,5K Token, Text bis zu 10 Pixel Größe, native Darstellung in 12 Sprachen, mehr als 100 Kunststile, komplexe Oberflächen und referenzbasierte Bearbeitung. Diese Sammlung rekonstruiert die offiziellen Beispiele als vollständige englische Produktionsprompts und kennzeichnet die Leistungsangaben als Herstellerangaben, nicht als unabhängige Messwerte.

> Die Prompts bleiben auf Englisch, damit alle Sprachfassungen dieselbe reproduzierbare Referenz verwenden.

### Was diese Sammlung prüft

- Dichte mehrteilige Publikationen und lange strukturierte Anweisungen
- Kleine Schrift, Formeln, Anmerkungen und mehrsprachige Typografie
- Realistische Haut-, Haar-, Papier-, Stoff- und Materialtexturen
- Referenzbearbeitung, Restaurierung, UI-Simulation und Wissensgrafiken
...
**[Bilder mit ImagineVid erstellen](https://imaginevid.io/de/ai-image-generator)**

<a id="workflow-index"></a>

## Workflow-Übersicht

- **Umfangreiches Informationsdesign**
- **Typografie und Publikation**
- **Oberflächen und Weltwissen**
- **Fotorealismus und Materialdetails**
- **Referenzbearbeitung und Restaurierung**
...
### 1. Wissensatlas aus neun Fachgebieten in einem Durchgang

Ein 3×3-Lehrblatt für lange Anweisungen, semantische Trennung, Formeln, Diagramme und lesbare zweisprachige Beschriftungen.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Wissensatlas aus neun Fachgebieten in einem Durchgang"></td>
</tr></table>

#### Quellennachweis

- **Urheber:** [Qwen Team](https://qwen.ai/)
- **Offizielles Beispiel:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Veröffentlicht:** 2026-07-21
- **Kategorie:** Umfangreiches Informationsdesign
...
### 2. Verschachtelte Softwareoberflächen

Vier erkennbare Arbeitsoberflächen als durchgehende Bild-in-Bild-Komposition mit klarer Hierarchie.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Verschachtelte Softwareoberflächen"></td>
</tr></table>
...
### 3. Forschungsführer zum Walhai

Eine dichte Meeresbiologie-Grafik zu Anatomie, Wanderung, Größenvergleich, Nahrung und Schutz.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Forschungsführer zum Walhai"></td>
</tr></table>
...
### 4. Präzise gesetzte Arbeit zur algebraischen Geometrie

Ein Publikationstest für mathematische Struktur, LaTeX-ähnliche Notation, Theoremhierarchie und Kleinschrift.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Präzise gesetzte Arbeit zur algebraischen Geometrie"></td>
</tr></table>
...
### 5. Titelseite einer Sonntagszeitung

Eine Druckkomposition aus langen Artikeln, Fotos, Spalten, Bildtexten und realistischer Papierwirkung.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Titelseite einer Sonntagszeitung"></td>
</tr></table>
...
### 6. Natürliche handschriftliche Lernnotizen

Referenzbearbeitung mit glaubhaften Notizen bei unveränderter Seite, Druckschrift, Beleuchtung und Perspektive.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Natürliche handschriftliche Lernnotizen"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Natürliche handschriftliche Lernnotizen"></td>
</tr></table>
...
### 7. Unretuschiertes Fensterporträt

Ein redaktionelles Porträt mit Poren, feinen Haaren, feuchten Augen, zurückhaltender Farbe und glaubwürdiger Optik.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Unretuschiertes Fensterporträt"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Unretuschiertes Fensterporträt"></td>
</tr></table>
...
### 8. Konservierende Restaurierung eines Tusche-Adlerbildes

Beschädigtes Papier und Pinselwerk werden ergänzt, während Alter, Komposition und Tuscherythmus erhalten bleiben.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Konservierende Restaurierung eines Tusche-Adlerbildes"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Konservierende Restaurierung eines Tusche-Adlerbildes"></td>
</tr></table>
...
### 9. Kulturplakate in drei Sprachen

Eine zusammengehörige Serie zur nativen japanischen, koreanischen und spanischen Typografie.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Kulturplakate in drei Sprachen"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Kulturplakate in drei Sprachen"></td>
</tr></table>
...
### 10. Regieraum für Live-Commerce

Eine Produktionsoberfläche für Video, Produkte, Moderation, Bestand und Leistungsdaten nach realer Bedienlogik.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Regieraum für Live-Commerce"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Regieraum für Live-Commerce"></td>
</tr></table>
...
### 11. Vom Insektenfoto zur Forschungstafel

Wissenschaftliche Bearbeitung mit erhaltenem Exemplar, Taxonomie, Anatomie, Vergrößerungen und Maßstab.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="Vom Insektenfoto zur Forschungstafel"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="Vom Insektenfoto zur Forschungstafel"></td>
</tr></table>
...
### 12. Kunstgeschichte-Livestream über Epochen hinweg

Eine Lernsituation aus historischem Bildwissen, moderner Oberfläche und klarer Kennzeichnung als Fiktion.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Kunstgeschichte-Livestream über Epochen hinweg"></td>
</tr></table>
...
### 14. Unterwasser-Aufstieg zu einem einzigen Lichtstrahl

Community-basierte Rekonstruktion mit Fokus auf Unterwasserstoff, glaubhafte Anatomie, Partikeltiefe, Negativraum und viele Hände.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN0jqoUaQAAfC8i.jpg" width="100%" alt="Unterwasser-Aufstieg zu einem einzigen Lichtstrahl"></td>
</tr></table>

#### Quellennachweis

- **Urheber:** [Zidan](https://x.com/liluocheng13)
- **Offizielles Beispiel:** [Qwen Image 3.0](https://x.com/liluocheng13/status/2079857838676209967)
...
### 15. Verschachtelter Code-Editor mit Chat-Poster

Mehrschichtiger UI-Prompt zum Prüfen lesbarer Oberflächentexte, räumlicher Tiefe und Poster-Erzeugung im Chat.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-ydubbcAAPs_n.png" width="100%" alt="Verschachtelter Code-Editor mit Chat-Poster"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-yelfakAAjQN9.png" width="100%" alt="Verschachtelter Code-Editor mit Chat-Poster"></td>
</tr></table>

#### Quellennachweis

- **Urheber:** [比特小师妹｜KiKi](https://x.com/bit_sister)
- **Offizielles Beispiel:** [Qwen Image 3.0](https://x.com/bit_sister/status/2080577815376957798)
...
### 16. Regnerische Istanbul-Szene als Texttest

Mehrsprachiger Straßenszenen-Prompt für türkische Schrift, Handschrift, nasse Reflexionen, natürliche Menschenmengen und realistische Anatomie.
...
<table><tr>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rO4cX0AAR78e.jpg" width="100%" alt="Regnerische Istanbul-Szene als Texttest"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rP9RWAAAst62.jpg" width="100%" alt="Regnerische Istanbul-Szene als Texttest"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rQ5tW0AAaIuX.jpg" width="100%" alt="Regnerische Istanbul-Szene als Texttest"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rRfiW4AA_Eje.jpg" width="100%" alt="Regnerische Istanbul-Szene als Texttest"></td>
</tr></table>

#### Quellennachweis

- **Urheber:** [Ozan Sihay](https://x.com/ozansihay)
- **Offizielles Beispiel:** [Qwen Image 3.0](https://x.com/ozansihay/status/2080218385607008613)
...
### 17. Vintage-Coquette-Referenzporträt

Referenzgeführter Beauty-Prompt für Identitätserhalt, realistische Hautstruktur, altrosa Styling und engen Editorial-Beschnitt.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5YtbNaYAAOIFV.jpg" width="100%" alt="Vintage-Coquette-Referenzporträt"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5Yum6bAAAIApb.jpg" width="100%" alt="Vintage-Coquette-Referenzporträt"></td>
</tr></table>

#### Quellennachweis

- **Urheber:** [Rich · Atom Tan Studio](https://x.com/atomtanstudio)
...
Reiche nur Fälle ein, die Qwen Image 3.0 ausdrücklich nennen, einen wiederverwendbaren Prompt, die Originalquelle und prüfbare Ergebnisbilder enthalten.

[Geprüften Prompt einreichen](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Lizenz und Quellenangabe

Von ImagineVid erstellter Code, Prompt-Rekonstruktionen, Übersetzungen und Redaktionstexte stehen unter CC BY 4.0. Offizielle Qwen-Beispiele und Medien verbleiben bei ihren Rechteinhabern und verlinken auf die Originalveröffentlichung. Qwen und Alibaba sind Marken ihrer Eigentümer. Diese unabhängige Sammlung ist nicht mit ihnen verbunden oder von ihnen unterstützt.

Kuratiert von Rowan Hale für ImagineVid.
