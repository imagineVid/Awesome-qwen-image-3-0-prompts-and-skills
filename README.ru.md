...
> Официальные примеры Qwen Image 3.0 переработаны в практические английские промпты с проверяемыми материалами и прозрачной атрибуцией.
...
- [Описание модели](#model-guide)
- [Категории рабочих процессов](#workflow-index)
- [Проверенные официальные примеры](#verified-showcase-cases)
- [Участие](#contribute)
...
Qwen Image 3.0 — третье поколение модели генерации и редактирования изображений команды Qwen. Официальный анонс выделяет насыщенность содержания, достоверность деталей и глубину знаний. Qwen заявляет поддержку инструкций до 4,5K токенов, текста размером 10 пикселей, нативного отображения 12 языков, более 100 художественных стилей, сложных интерфейсов и редактирования по референсу. Коллекция превращает официальные демонстрации в полные английские производственные промпты и отделяет заявления разработчика от независимых тестов.

> Тексты промптов остаются на английском, чтобы все языковые версии использовали единый воспроизводимый оригинал.

### Что проверяет коллекция

- Плотные многопанельные публикации и длинные структурированные инструкции
- Мелкий текст, формулы, пометки и многоязычная типографика
- Реалистичные текстуры кожи, волос, бумаги, ткани и материалов
- Редактирование по референсу, реставрация, интерфейсы и графика знаний
...
**[Создать изображение в ImagineVid](https://imaginevid.io/ru/ai-image-generator)**

<a id="workflow-index"></a>

## Категории рабочих процессов

- **Развёрнутый информационный дизайн**
- **Типографика и публикации**
- **Интерфейсы и знания о мире**
- **Фотореализм и детали материалов**
- **Редактирование и реставрация по референсу**

<a id="verified-showcase-cases"></a>

## Проверенные официальные примеры

| Состояние коллекции | 19 проверенных примеров |
|---|---:|
| Последнее обновление | 2026-07-21 |

### 1. Атлас девяти областей знания за одну генерацию

Учебная сетка 3×3 для проверки длинных инструкций, разделения смыслов, формул, схем и читаемого двуязычного текста.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Атлас девяти областей знания за одну генерацию"></td>
</tr></table>

#### Подтверждение источника

- **Автор:** [Qwen Team](https://qwen.ai/)
- **Официальная демонстрация:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Опубликовано:** 2026-07-21
- **Категория:** Развёрнутый информационный дизайн
...
### 2. Вложенные программные интерфейсы

Четыре узнаваемые рабочие среды в единой композиции с сохранением иерархии.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Вложенные программные интерфейсы"></td>
</tr></table>
...
- **Официальная демонстрация:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Опубликовано:** 2026-07-21
- **Категория:** Интерфейсы и знания о мире
- **Нужны референсные изображения:** Нет
...
### 3. Научный справочник о китовой акуле

Плотная морская инфографика об анатомии, миграции, масштабе, питании и охране.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Научный справочник о китовой акуле"></td>
</tr></table>
...
### 4. Точно сверстанная статья по алгебраической геометрии

Издательский тест математической структуры, LaTeX-подобной записи, иерархии теорем и мелкого текста.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Точно сверстанная статья по алгебраической геометрии"></td>
</tr></table>
...
### 5. Первая полоса воскресной газеты

Печатная композиция из длинного текста, фотографий, колонок, подписей и реалистичной бумаги.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Первая полоса воскресной газеты"></td>
</tr></table>
...
### 6. Естественные рукописные учебные пометки

Редактирование по референсу с правдоподобными заметками без изменения страницы, печати, света и перспективы.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Естественные рукописные учебные пометки"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Естественные рукописные учебные пометки"></td>
</tr></table>
...
### 7. Портрет у окна без ретуши

Редакционный портрет с естественными порами, тонкими волосками, влажными глазами, сдержанным цветом и оптикой.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Портрет у окна без ретуши"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Портрет у окна без ретуши"></td>
</tr></table>
...
### 8. Консервационная реставрация тушевой картины с орлами

Восстановление повреждений с сохранением возраста, композиции и ритма кисти.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Консервационная реставрация тушевой картины с орлами"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Консервационная реставрация тушевой картины с орлами"></td>
</tr></table>
...
### 9. Серия культурных плакатов на трёх языках

Единая система, проверяющая естественную японскую, корейскую и испанскую типографику.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Серия культурных плакатов на трёх языках"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Серия культурных плакатов на трёх языках"></td>
</tr></table>
...
### 10. Режиссёрская панель прямых продаж

Производственный интерфейс для видео, товаров, модерации, запасов и показателей по реальной логике работы.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Режиссёрская панель прямых продаж"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Режиссёрская панель прямых продаж"></td>
</tr></table>
...
### 11. Из фотографии насекомого в научную таблицу

Научное редактирование с сохранением образца и добавлением таксономии, анатомии, увеличений и масштаба.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="Из фотографии насекомого в научную таблицу"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="Из фотографии насекомого в научную таблицу"></td>
</tr></table>
...
### 12. Межэпоховый эфир по истории искусства

Учебная сцена, объединяющая исторические знания, современный интерфейс и явную маркировку вымысла.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Межэпоховый эфир по истории искусства"></td>
</tr></table>
...
### 13. Двухпанельная чёрно-белая манга с точным японским диалогом

Производственная реконструкция по примеру сообщества для проверки связности кадров, сдержанной графики, вертикального текста и точных реплик.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Двухпанельная чёрно-белая манга с точным японским диалогом"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Двухпанельная чёрно-белая манга с точным японским диалогом"></td>
</tr></table>

#### Подтверждение источника

- **Автор:** [Yasun](https://x.com/yasun_ai)
...
### 18. Редактирование образа бунтарской рок-звезды

Кейс с подтверждённым источником о задаче «Редактирование образа бунтарской рок-звезды», с повторно используемыми инструкциями и проверяемым результатом.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vClvW4AA8M-H.jpg" width="100%" alt="Редактирование образа бунтарской рок-звезды"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vDMGWoAAHCnh.jpg" width="100%" alt="Редактирование образа бунтарской рок-звезды"></td>
</tr></table>

#### Подтверждение источника

- **Автор:** [Ash](https://x.com/asheem01)
- **Официальная демонстрация:** [Qwen Image 3.0](https://x.com/asheem01/status/2079940712322199938)
- **Опубликовано:** 2026-07-22
- **Категория:** Редактирование и реставрация по референсу
- **Нужны референсные изображения:** Да
...
### 20. Обложка журнала в каплях дождя со стеклянным шахматным конём

Публикационный кейс Qwen Image 3 с подтверждённым источником: точная типографика обложки, отражающее стекло, прозрачный объект и ночной редакционный свет.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN2kFdfWsAEQTO-.jpg" width="100%" alt="Обложка журнала в каплях дождя со стеклянным шахматным конём"></td>
</tr></table>

#### Подтверждение источника

- **Автор:** [Ivana](https://x.com/ivanainai)
- **Официальная демонстрация:** [Qwen Image 3.0](https://x.com/ivanainai/status/2080000842959106328)
- **Опубликовано:** 2026-07-22
- **Категория:** Типографика и публикации
- **Нужны референсные изображения:** Да
...
Принимайте только случаи, где явно указан Qwen Image 3.0, есть пригодный промпт, первоисточник и доступный для проверки результат.

[Предложить проверенный промпт](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Лицензия и атрибуция

Код, реконструкции промптов, переводы и редакционные тексты ImagineVid распространяются по CC BY 4.0. Официальные примеры и медиа Qwen принадлежат их правообладателям и связаны с исходной публикацией. Qwen и Alibaba — товарные знаки их владельцев. Эта независимая коллекция не связана с ними и не одобрена ими.

Подготовлено Rowan Hale для ImagineVid.
