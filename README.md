...
> Official Qwen Image 3.0 showcase concepts rebuilt as reusable English production prompts, with inspectable media and transparent attribution.
...
- [Verified official showcase cases](#verified-showcase-cases)
...
Qwen Image 3.0 is the third-generation image generation and editing model from the Qwen team. Its official launch frames the model around rich content, authentic details, and deep knowledge. Qwen reports support for instructions up to 4.5K tokens, text as small as 10 pixels, native rendering across 12 languages, more than 100 artistic styles, complex interfaces, and reference editing. This collection turns launch-day showcase concepts into complete English production prompts while presenting those capabilities as first-party claims rather than independent benchmark results.

> Prompt bodies remain in English so every locale points to one reproducible canonical version.

### What this collection tests

- Dense multi-panel publications and long structured instructions
- Fine text, formulas, annotations, and multilingual typography
- Photorealistic skin, hair, paper, fabric, and material texture
- Reference editing, restoration, interface simulation, and knowledge graphics
...
**[Create images on ImagineVid](https://imaginevid.io/ai-image-generator)**

<a id="workflow-index"></a>

## Workflow index

- **Long-Form Information Design**
- **Typography & Publication**
- **Interfaces & World Knowledge**
- **Photorealism & Material Detail**
- **Reference Editing & Restoration**

<a id="verified-showcase-cases"></a>

## Verified official showcase cases

| Collection status | 19 verified cases |
|---|---:|
| Last generated | 2026-07-21 |

### 1. Nine-domain knowledge atlas in one pass

A 3x3 educational atlas that tests long-instruction following, semantic separation, formulas, diagrams, and readable bilingual labels on one canvas.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Nine-domain knowledge atlas in one pass"></td>
</tr></table>

#### Source evidence

- **Creator:** [Qwen Team](https://qwen.ai/)
- **Official showcase:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Published:** 2026-07-21
- **Category:** Long-Form Information Design
- **Reference images required:** No

**[Use this prompt on ImagineVid](https://imaginevid.io/ai-image-generator)**

---

### 2. Nested software interfaces with picture-in-picture depth

A single nested-interface composition that coordinates four recognizable workspace layers without flattening their hierarchy.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Nested software interfaces with picture-in-picture depth"></td>
</tr></table>
...
- **Official showcase:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Published:** 2026-07-21
- **Category:** Interfaces & World Knowledge
- **Reference images required:** No
...
### 3. Whale shark research field guide

A dense marine-biology infographic that combines anatomy, migration, scale, diet, and conservation information without sacrificing hierarchy.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Whale shark research field guide"></td>
</tr></table>
...
### 4. Algebraic geometry paper with exact typesetting

A publication stress test for mathematical structure, LaTeX-like notation, theorem hierarchy, and small-text legibility.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Algebraic geometry paper with exact typesetting"></td>
</tr></table>
...
- **Official showcase:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Published:** 2026-07-21
- **Category:** Typography & Publication
- **Reference images required:** No
...
### 5. Sunday newspaper front page

A physical-print composition that coordinates dense editorial text, photographs, columns, captions, rules, and paper realism.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Sunday newspaper front page"></td>
</tr></table>
...
### 6. Natural handwritten study annotations

A reference edit that adds believable student notes while preserving the photographed page, printed text, lighting, and camera geometry.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Natural handwritten study annotations"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Natural handwritten study annotations"></td>
</tr></table>
...
### 7. Unretouched window-light portrait

A close editorial portrait focused on natural pores, fine hair, moist eyes, tonal restraint, and believable optical behavior.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Unretouched window-light portrait"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Unretouched window-light portrait"></td>
</tr></table>
...
### 8. Conservation repair of an ink eagle painting

A restoration edit that reconstructs missing paper and brushwork while retaining age, composition, ink rhythm, and material evidence.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Conservation repair of an ink eagle painting"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Conservation repair of an ink eagle painting"></td>
</tr></table>
...
### 9. Three-language cultural poster series

A coordinated poster set testing native Japanese, Korean, and Spanish typography while preserving distinct local design voices.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Three-language cultural poster series"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Three-language cultural poster series"></td>
</tr></table>
...
### 10. Live commerce control room interface

A realistic production UI balancing video, product operations, moderation, inventory, and performance data in one coherent system.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Live commerce control room interface"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Live commerce control room interface"></td>
</tr></table>
...
### 11. Insect photograph turned into a research plate

A reference-guided scientific edit that preserves the specimen and adds taxonomic structure, anatomy, magnified views, and scale.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="Insect photograph turned into a research plate"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="Insect photograph turned into a research plate"></td>
</tr></table>
...
### 12. Cross-era art history livestream set

A fictional educational broadcast scene combining historical visual knowledge, contemporary interface design, and clearly labeled interpretation.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Cross-era art history livestream set"></td>
</tr></table>
...
### 13. Two-panel monochrome manga with exact Japanese dialogue

A community-backed production reconstruction for testing panel continuity, restrained manga rendering, vertical Japanese text, and exact speech-bubble copy.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Two-panel monochrome manga with exact Japanese dialogue"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Two-panel monochrome manga with exact Japanese dialogue"></td>
</tr></table>

#### Source evidence

- **Creator:** [Yasun](https://x.com/yasun_ai)
- **Official showcase:** [Qwen Image 3.0](https://x.com/yasun_ai/status/2079531572919996636)
- **Published:** 2026-07-21
- **Category:** Typography & Publication
- **Reference images required:** No
...
### 14. Underwater ascent toward a single shaft of light

A community-backed production reconstruction focused on submerged fabric, believable anatomy, particulate depth, controlled negative space, and many reaching hands.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN0jqoUaQAAfC8i.jpg" width="100%" alt="Underwater ascent toward a single shaft of light"></td>
</tr></table>

#### Source evidence

- **Creator:** [Zidan](https://x.com/liluocheng13)
- **Official showcase:** [Qwen Image 3.0](https://x.com/liluocheng13/status/2079857838676209967)
...
### 15. Nested code editor and chat poster workflow

A layered interface-composition prompt that tests readable UI text, spatial depth, and poster generation inside a chat workspace.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-ydubbcAAPs_n.png" width="100%" alt="Nested code editor and chat poster workflow"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-yelfakAAjQN9.png" width="100%" alt="Nested code editor and chat poster workflow"></td>
</tr></table>

#### Source evidence

- **Creator:** [比特小师妹｜KiKi](https://x.com/bit_sister)
- **Official showcase:** [Qwen Image 3.0](https://x.com/bit_sister/status/2080577815376957798)
...
### 17. Vintage coquette reference portrait close-up

A reference-guided beauty portrait prompt focused on identity preservation, realistic skin texture, old-rose styling, and close editorial framing.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5YtbNaYAAOIFV.jpg" width="100%" alt="Vintage coquette reference portrait close-up"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5Yum6bAAAIApb.jpg" width="100%" alt="Vintage coquette reference portrait close-up"></td>
</tr></table>

#### Source evidence

- **Creator:** [Rich · Atom Tan Studio](https://x.com/atomtanstudio)
...
### 19. Song-style portrait with refined ink-and-photography light

A source-backed Qwen Image 3 portrait that combines Song-inspired composition, readable calligraphy, silk texture, and restrained editorial color.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN1YAvkagAAoW3N.jpg" width="100%" alt="Song-style portrait with refined ink-and-photography light"></td>
</tr></table>

#### Source evidence

- **Creator:** [岚叔](https://x.com/LufzzLiz)
- **Official showcase:** [Qwen Image 3.0](https://x.com/LufzzLiz/status/2079925505634234856)
- **Published:** 2026-07-22
- **Category:** Reference Editing & Restoration
- **Reference images required:** No
...
### 20. Rain-speckled magazine cover with a glass chess knight

A source-backed Qwen Image 3 publication case combining exact cover typography, reflective glass, a transparent object, and night editorial lighting.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN2kFdfWsAEQTO-.jpg" width="100%" alt="Rain-speckled magazine cover with a glass chess knight"></td>
</tr></table>

#### Source evidence

- **Creator:** [Ivana](https://x.com/ivanainai)
- **Official showcase:** [Qwen Image 3.0](https://x.com/ivanainai/status/2080000842959106328)
- **Published:** 2026-07-22
- **Category:** Typography & Publication
- **Reference images required:** Yes
...
Submit only cases that explicitly identify Qwen Image 3.0, include a reusable prompt, preserve canonical attribution, and expose inspectable result media.

[Submit a verified prompt](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## License and attribution

ImagineVid-authored code, production-prompt reconstructions, translations, and editorial text are licensed under CC BY 4.0. Qwen's official examples and media remain the property of their respective owner and are linked to the canonical launch article. Qwen and Alibaba are trademarks of their owners. This independent collection is not affiliated with or endorsed by Qwen or Alibaba.

Curated by Rowan Hale for ImagineVid.
