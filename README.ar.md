...
> إعادة بناء العروض الرسمية لـ Qwen Image 3.0 كمطالبات إنتاج إنجليزية قابلة لإعادة الاستخدام، مع وسائط قابلة للتحقق ونَسب واضح.
...
- [فهرس مسارات العمل](#workflow-index)
- [حالات العرض الرسمية الموثقة](#verified-showcase-cases)
- [المساهمة](#contribute)
- [الترخيص ونَسب المحتوى](#license-and-attribution)

<a id="model-guide"></a>

## دليل النموذج

Qwen Image 3.0 هو الجيل الثالث من نموذج إنشاء الصور وتحريرها لدى فريق Qwen. يركز الإطلاق الرسمي على ثراء المحتوى وواقعية التفاصيل وعمق المعرفة. وتعلن Qwen دعم تعليمات تصل إلى 4.5 آلاف رمز، ونص بحجم 10 بكسلات، وعرض أصلي لـ12 لغة، وأكثر من 100 أسلوب فني، وواجهات معقدة، وتحرير قائم على المراجع. تحول هذه المجموعة العروض الرسمية إلى مطالبات إنتاج إنجليزية كاملة، وتعرض تلك القدرات باعتبارها ادعاءات رسمية لا نتائج قياس مستقلة.

> تبقى نصوص المطالبات بالإنجليزية كي تعتمد جميع اللغات نسخة معيارية واحدة قابلة لإعادة الإنتاج.

### ما الذي تختبره هذه المجموعة

- منشورات كثيفة متعددة اللوحات وتعليمات طويلة ومنظمة
- نصوص صغيرة ومعادلات وتعليقات وطباعة متعددة اللغات
- ملامس واقعية للبشرة والشعر والورق والنسيج والمواد
- تحرير بالمرجع وترميم ومحاكاة واجهات ورسوم معرفية
...
**[أنشئ صورًا في ImagineVid](https://imaginevid.io/ar/ai-image-generator)**
...
- **تصميم معلومات طويل**
- **الطباعة والنشر**
- **الواجهات والمعرفة العالمية**
- **الواقعية الفوتوغرافية وتفاصيل المواد**
- **التحرير والترميم بالمرجع**
...
### 1. أطلس لتسعة مجالات معرفية في توليد واحد

لوحة تعليمية 3×3 تختبر التعليمات الطويلة وفصل المعاني والمعادلات والرسوم والنص الثنائي المقروء.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="أطلس لتسعة مجالات معرفية في توليد واحد"></td>
</tr></table>

#### دليل المصدر

- **المنشئ:** [Qwen Team](https://qwen.ai/)
- **العرض الرسمي:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **تاريخ النشر:** 2026-07-21
- **الفئة:** تصميم معلومات طويل
...
### 2. واجهات برمجية متداخلة

أربع بيئات عمل واضحة داخل تكوين متصل يحافظ على تسلسلها الهرمي.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="واجهات برمجية متداخلة"></td>
</tr></table>
...
### 3. دليل بحثي لقرش الحوت

إنفوجرافيك بحري كثيف يجمع التشريح والهجرة والمقياس والغذاء والحماية ضمن تسلسل واضح.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="دليل بحثي لقرش الحوت"></td>
</tr></table>
...
### 4. ورقة هندسة جبرية دقيقة التنضيد

اختبار نشر للبنية الرياضية والترميز الشبيه بـ LaTeX وتسلسل النظريات والنصوص الصغيرة.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="ورقة هندسة جبرية دقيقة التنضيد"></td>
</tr></table>
...
### 5. الصفحة الأولى لصحيفة الأحد

تكوين مطبوع ينسق النص الطويل والصور والأعمدة والتعليقات وملمس الورق الواقعي.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="الصفحة الأولى لصحيفة الأحد"></td>
</tr></table>
...
### 6. ملاحظات دراسية طبيعية بخط اليد

تحرير مرجعي يضيف ملاحظات مقنعة من دون تغيير الصفحة أو النص أو الإضاءة أو المنظور.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="ملاحظات دراسية طبيعية بخط اليد"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="ملاحظات دراسية طبيعية بخط اليد"></td>
</tr></table>
...
### 7. صورة شخصية قرب النافذة بلا تنقيح

صورة تحريرية تركز على المسام والشعر الدقيق ورطوبة العين والألوان الهادئة والبصريات الطبيعية.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="صورة شخصية قرب النافذة بلا تنقيح"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="صورة شخصية قرب النافذة بلا تنقيح"></td>
</tr></table>
...
### 8. ترميم محافظ للوحة نسور بالحبر

إعادة بناء التلف مع الحفاظ على العمر والتكوين وإيقاع ضربات الفرشاة.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="ترميم محافظ للوحة نسور بالحبر"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="ترميم محافظ للوحة نسور بالحبر"></td>
</tr></table>
...
### 9. سلسلة ملصقات ثقافية بثلاث لغات

هوية موحدة تختبر الطباعة الطبيعية باليابانية والكورية والإسبانية.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="سلسلة ملصقات ثقافية بثلاث لغات"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="سلسلة ملصقات ثقافية بثلاث لغات"></td>
</tr></table>
...
### 10. غرفة تحكم للتجارة المباشرة

واجهة إنتاج تنظم الفيديو والمنتجات والإشراف والمخزون والأداء وفق أولويات تشغيل حقيقية.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="غرفة تحكم للتجارة المباشرة"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="غرفة تحكم للتجارة المباشرة"></td>
</tr></table>
...
### 11. من صورة حشرة إلى لوحة بحثية

تحرير علمي يحافظ على العينة ويضيف التصنيف والتشريح والتكبير والمقياس.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="من صورة حشرة إلى لوحة بحثية"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="من صورة حشرة إلى لوحة بحثية"></td>
</tr></table>
...
### 12. بث لتاريخ الفن عبر العصور

مشهد تعليمي يجمع المعرفة التاريخية والواجهة الحديثة والتنبيه الواضح إلى الطابع الخيالي.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="بث لتاريخ الفن عبر العصور"></td>
</tr></table>
...
### 19. بورتريه بروح أسرة سونغ مع حبر رقيق وإضاءة فوتوغرافية

بورتريه موثق المصدر من Qwen Image 3 يجمع تكوينًا مستوحى من سونغ، وخطًا مقروءًا، وملمس الحرير، وألوانًا تحريرية هادئة.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN1YAvkagAAoW3N.jpg" width="100%" alt="بورتريه بروح أسرة سونغ مع حبر رقيق وإضاءة فوتوغرافية"></td>
</tr></table>

#### دليل المصدر

- **المنشئ:** [岚叔](https://x.com/LufzzLiz)
- **العرض الرسمي:** [Qwen Image 3.0](https://x.com/LufzzLiz/status/2079925505634234856)
- **تاريخ النشر:** 2026-07-22
- **الفئة:** التحرير والترميم بالمرجع
- **تتطلب صورًا مرجعية:** لا
...
أرسل فقط الحالات التي تذكر Qwen Image 3.0 بوضوح، وتتضمن مطالبة قابلة لإعادة الاستخدام ومصدرًا أصليًا ونتيجة قابلة للفحص.

[إرسال مطالبة موثقة](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## الترخيص ونَسب المحتوى

تخضع الشفرة وإعادة صياغة المطالبات والترجمات والنصوص التحريرية التي أعدتها ImagineVid لترخيص CC BY 4.0. تبقى أمثلة Qwen الرسمية ووسائطها ملكًا لأصحاب الحقوق وترتبط بالإعلان الأصلي. Qwen وAlibaba علامتان تجاريتان لمالكيهما. هذه المجموعة المستقلة غير تابعة لهما ولا تحظى بتأييدهما.

إعداد Rowan Hale لصالح ImagineVid.
