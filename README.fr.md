...
> Des cas officiels Qwen Image 3.0 reconstruits en prompts de production anglais réutilisables, avec médias vérifiables et attribution transparente.
...
- [Guide du modèle](#model-guide)
- [Index des workflows](#workflow-index)
- [Cas officiels vérifiés](#verified-showcase-cases)
- [Contribuer](#contribute)
- [Licence et attribution](#license-and-attribution)

<a id="model-guide"></a>

## Guide du modèle

Qwen Image 3.0 est la troisième génération du modèle de génération et d'édition d'images de l'équipe Qwen. Son lancement officiel s'articule autour de trois axes : richesse du contenu, authenticité des détails et profondeur des connaissances. Qwen annonce des instructions jusqu'à 4,5K tokens, du texte de 10 pixels, un rendu natif dans 12 langues, plus de 100 styles artistiques, des interfaces complexes et l'édition par référence. Cette collection transforme les démonstrations officielles en prompts de production anglais complets et présente ces capacités comme des déclarations du constructeur, non comme des résultats indépendants.

> Les prompts restent en anglais afin que toutes les langues partagent une version canonique reproductible.

### Ce que cette collection met à l'épreuve

- Publications denses à plusieurs panneaux et longues instructions structurées
- Petits caractères, formules, annotations et typographie multilingue
- Textures réalistes de peau, cheveux, papier, tissu et matériaux
- Édition par référence, restauration, simulation d'interface et graphiques de connaissance
...
**[Créer des images sur ImagineVid](https://imaginevid.io/fr/ai-image-generator)**

<a id="workflow-index"></a>

## Index des workflows

- **Design d'information long format**
- **Typographie et publication**
- **Interfaces et connaissance du monde**
- **Photoréalisme et détails de matière**
- **Édition et restauration par référence**

<a id="verified-showcase-cases"></a>

## Cas officiels vérifiés

| État de la collection | 19 cas vérifiés |
|---|---:|
| Dernière génération | 2026-07-21 |

### 1. Atlas de neuf domaines en une seule génération

Une planche éducative 3×3 qui teste les longues consignes, la séparation sémantique, les formules, les schémas et les légendes bilingues.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Atlas de neuf domaines en une seule génération"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [Qwen Team](https://qwen.ai/)
- **Démonstration officielle:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publié le:** 2026-07-21
- **Catégorie:** Design d'information long format
- **Images de référence requises:** Non

**[Utiliser ce prompt sur ImagineVid](https://imaginevid.io/fr/ai-image-generator)**

---

### 2. Interfaces logicielles imbriquées

Quatre espaces de travail reconnaissables dans une composition continue qui conserve leur hiérarchie.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Interfaces logicielles imbriquées"></td>
</tr></table>
...
- **Démonstration officielle:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publié le:** 2026-07-21
- **Catégorie:** Interfaces et connaissance du monde
- **Images de référence requises:** Non
...
### 3. Guide scientifique du requin-baleine

Une infographie marine dense associant anatomie, migration, échelle, alimentation et conservation.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Guide scientifique du requin-baleine"></td>
</tr></table>
...
### 4. Article de géométrie algébrique à la composition précise

Un test éditorial pour la structure mathématique, la notation type LaTeX, les théorèmes et les petits caractères.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Article de géométrie algébrique à la composition précise"></td>
</tr></table>
...
- **Démonstration officielle:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publié le:** 2026-07-21
- **Catégorie:** Typographie et publication
- **Images de référence requises:** Non
...
### 5. Une d'un journal du dimanche

Une composition imprimée qui coordonne texte long, photos, colonnes, légendes et texture réaliste du papier.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Une d'un journal du dimanche"></td>
</tr></table>
...
### 6. Annotations d'étude manuscrites naturelles

Une édition de référence qui ajoute des notes crédibles sans modifier la page, le texte, la lumière ni la perspective.
...
- **Démonstration officielle:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publié le:** 2026-07-21
- **Catégorie:** Édition et restauration par référence
- **Images de référence requises:** Oui

**[Utiliser ce prompt sur ImagineVid](https://imaginevid.io/fr/ai-image-generator)**

---

### 7. Portrait à la fenêtre sans retouche

Un portrait éditorial centré sur les pores, les cheveux fins, les yeux humides, les tons retenus et une optique crédible.
...
- **Démonstration officielle:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publié le:** 2026-07-21
- **Catégorie:** Photoréalisme et détails de matière
- **Images de référence requises:** Non
...
### 8. Restauration d'une peinture d'aigles à l'encre

Reconstruction des zones endommagées en préservant l'âge, la composition et le rythme du pinceau.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Restauration d'une peinture d'aigles à l'encre"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Restauration d'une peinture d'aigles à l'encre"></td>
</tr></table>
...
### 9. Série d'affiches culturelles en trois langues

Une identité commune qui met à l'épreuve la typographie native japonaise, coréenne et espagnole.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Série d'affiches culturelles en trois langues"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Série d'affiches culturelles en trois langues"></td>
</tr></table>
...
### 10. Régie de commerce en direct

Une interface de production réunissant vidéo, produits, modération, stock et performances selon une logique opérationnelle.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Régie de commerce en direct"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Régie de commerce en direct"></td>
</tr></table>
...
### 11. D'une photo d'insecte à une planche de recherche

Une édition scientifique qui conserve le spécimen et ajoute taxonomie, anatomie, détails agrandis et échelle.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="D'une photo d'insecte à une planche de recherche"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="D'une photo d'insecte à une planche de recherche"></td>
</tr></table>
...
### 12. Émission d'histoire de l'art entre les époques

Une scène pédagogique mêlant savoir historique, interface moderne et signalement explicite de la fiction.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Émission d'histoire de l'art entre les époques"></td>
</tr></table>
...
### 13. Manga monochrome en deux cases avec dialogue japonais exact

Reconstruction de production issue d'un cas communautaire pour tester continuité, trait sobre, texte vertical et bulles précises.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Manga monochrome en deux cases avec dialogue japonais exact"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Manga monochrome en deux cases avec dialogue japonais exact"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [Yasun](https://x.com/yasun_ai)
- **Démonstration officielle:** [Qwen Image 3.0](https://x.com/yasun_ai/status/2079531572919996636)
- **Publié le:** 2026-07-21
- **Catégorie:** Typographie et publication
- **Images de référence requises:** Non
...
### 14. Ascension sous-marine vers un unique rayon

Reconstruction communautaire axée sur tissu immergé, anatomie crédible, profondeur particulaire, espace négatif et mains tendues.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN0jqoUaQAAfC8i.jpg" width="100%" alt="Ascension sous-marine vers un unique rayon"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [Zidan](https://x.com/liluocheng13)
- **Démonstration officielle:** [Qwen Image 3.0](https://x.com/liluocheng13/status/2079857838676209967)
...
### 15. Editeur de code imbrique et affiche dans le chat

Prompt d interface en couches pour tester le texte UI lisible, la profondeur spatiale et la creation d affiche dans un chat.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-ydubbcAAPs_n.png" width="100%" alt="Editeur de code imbrique et affiche dans le chat"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-yelfakAAjQN9.png" width="100%" alt="Editeur de code imbrique et affiche dans le chat"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [比特小师妹｜KiKi](https://x.com/bit_sister)
- **Démonstration officielle:** [Qwen Image 3.0](https://x.com/bit_sister/status/2080577815376957798)
...
### 17. Portrait coquette vintage avec reference

Prompt de portrait guide par reference, centre sur l identite, la texture de peau realiste, le style vieux rose et le cadrage editorial serre.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5YtbNaYAAOIFV.jpg" width="100%" alt="Portrait coquette vintage avec reference"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5Yum6bAAAIApb.jpg" width="100%" alt="Portrait coquette vintage avec reference"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [Rich · Atom Tan Studio](https://x.com/atomtanstudio)
- **Démonstration officielle:** [Qwen Image 3.0](https://x.com/atomtanstudio/status/2080197723429711958)
...
### 18. Édition d’identité d’une rockeuse rebelle

Un cas documenté par une source autour de « Édition d’identité d’une rockeuse rebelle », avec des instructions réutilisables et un résultat vérifiable.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vClvW4AA8M-H.jpg" width="100%" alt="Édition d’identité d’une rockeuse rebelle"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vDMGWoAAHCnh.jpg" width="100%" alt="Édition d’identité d’une rockeuse rebelle"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [Ash](https://x.com/asheem01)
- **Démonstration officielle:** [Qwen Image 3.0](https://x.com/asheem01/status/2079940712322199938)
- **Publié le:** 2026-07-22
- **Catégorie:** Édition et restauration par référence
- **Images de référence requises:** Oui
...
### 19. Portrait d’inspiration Song à l’encre délicate et lumière photographique

Un portrait Qwen Image 3 documenté par une source, qui associe une composition inspirée des Song, une calligraphie lisible, une texture de soie et une palette éditoriale maîtrisée.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN1YAvkagAAoW3N.jpg" width="100%" alt="Portrait d’inspiration Song à l’encre délicate et lumière photographique"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [岚叔](https://x.com/LufzzLiz)
- **Démonstration officielle:** [Qwen Image 3.0](https://x.com/LufzzLiz/status/2079925505634234856)
- **Publié le:** 2026-07-22
- **Catégorie:** Édition et restauration par référence
- **Images de référence requises:** Non
...
### 20. Couverture de magazine mouillée par la pluie avec cavalier d’échecs en verre

Un cas éditorial Qwen Image 3 documenté par une source, associant une typographie de couverture précise, du verre réfléchissant, un objet transparent et une lumière éditoriale nocturne.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN2kFdfWsAEQTO-.jpg" width="100%" alt="Couverture de magazine mouillée par la pluie avec cavalier d’échecs en verre"></td>
</tr></table>

#### Preuve de la source

- **Créateur:** [Ivana](https://x.com/ivanainai)
- **Démonstration officielle:** [Qwen Image 3.0](https://x.com/ivanainai/status/2080000842959106328)
- **Publié le:** 2026-07-22
- **Catégorie:** Typographie et publication
- **Images de référence requises:** Oui
...
Ne proposez que des cas mentionnant explicitement Qwen Image 3.0, avec un prompt réutilisable, la source canonique et un résultat consultable.

[Proposer un prompt vérifié](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Licence et attribution

Le code, les reconstructions de prompts, les traductions et les textes éditoriaux créés par ImagineVid sont sous licence CC BY 4.0. Les exemples et médias officiels de Qwen restent la propriété de leurs ayants droit et renvoient à l'annonce d'origine. Qwen et Alibaba sont des marques de leurs propriétaires. Cette collection indépendante n'est ni affiliée ni approuvée par eux.

Sélection de Rowan Hale pour ImagineVid.
