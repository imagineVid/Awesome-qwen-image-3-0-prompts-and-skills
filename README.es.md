...
> Casos oficiales de Qwen Image 3.0 reconstruidos como prompts de producción reutilizables en inglés, con material verificable y atribución transparente.
...
- [Guía del modelo](#model-guide)
- [Índice de flujos de trabajo](#workflow-index)
- [Casos oficiales verificados](#verified-showcase-cases)
- [Contribuir](#contribute)
- [Licencia y atribución](#license-and-attribution)

<a id="model-guide"></a>

## Guía del modelo

Qwen Image 3.0 es la tercera generación del modelo de creación y edición de imágenes del equipo Qwen. El lanzamiento oficial lo presenta mediante tres ejes: contenido abundante, detalles auténticos y conocimiento profundo. Qwen declara instrucciones de hasta 4,5K tokens, texto de 10 píxeles, representación nativa en 12 idiomas, más de 100 estilos artísticos, interfaces complejas y edición con referencias. Esta colección convierte las demostraciones oficiales en prompts completos de producción en inglés y distingue esas prestaciones como afirmaciones del fabricante, no como resultados independientes.

> Los prompts se mantienen en inglés para que todos los idiomas compartan una versión canónica reproducible.

### Qué pone a prueba esta colección

- Publicaciones densas de varios paneles e instrucciones largas
- Texto pequeño, fórmulas, anotaciones y tipografía multilingüe
- Texturas realistas de piel, cabello, papel, tela y materiales
- Edición con referencias, restauración, simulación de interfaces y gráficos de conocimiento
...
**[Crear imágenes en ImagineVid](https://imaginevid.io/es/ai-image-generator)**

<a id="workflow-index"></a>

## Índice de flujos de trabajo

- **Diseño de información extenso**
- **Tipografía y publicación**
- **Interfaces y conocimiento del mundo**
- **Fotorrealismo y detalle material**
- **Edición y restauración con referencias**
...
### 1. Atlas de nueve áreas de conocimiento en una sola generación

Una cuadrícula educativa 3×3 que prueba instrucciones largas, separación semántica, fórmulas, diagramas y texto bilingüe legible.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Atlas de nueve áreas de conocimiento en una sola generación"></td>
</tr></table>

#### Evidencia de la fuente

- **Creador:** [Qwen Team](https://qwen.ai/)
- **Demostración oficial:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publicado:** 2026-07-21
- **Categoría:** Diseño de información extenso
...
### 2. Interfaces de software anidadas

Cuatro espacios de trabajo reconocibles dentro de una composición continua sin perder su jerarquía.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="Interfaces de software anidadas"></td>
</tr></table>
...
- **Demostración oficial:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Publicado:** 2026-07-21
- **Categoría:** Interfaces y conocimiento del mundo
- **Requiere imágenes de referencia:** No
...
### 3. Guía científica del tiburón ballena

Una infografía marina densa que reúne anatomía, migración, escala, dieta y conservación con jerarquía clara.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Guía científica del tiburón ballena"></td>
</tr></table>
...
### 4. Artículo de geometría algebraica con composición precisa

Una prueba editorial de estructura matemática, notación tipo LaTeX, jerarquía de teoremas y letra pequeña.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Artículo de geometría algebraica con composición precisa"></td>
</tr></table>
...
### 5. Portada de un periódico dominical

Una composición impresa que coordina texto extenso, fotos, columnas, pies y textura realista de papel.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Portada de un periódico dominical"></td>
</tr></table>
...
### 6. Anotaciones de estudio manuscritas

Edición con referencia que añade notas verosímiles sin alterar la página, el texto impreso, la luz ni la perspectiva.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Anotaciones de estudio manuscritas"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Anotaciones de estudio manuscritas"></td>
</tr></table>
...
### 7. Retrato junto a la ventana sin retoque

Retrato editorial centrado en poros, vello fino, ojos húmedos, color contenido y óptica creíble.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Retrato junto a la ventana sin retoque"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Retrato junto a la ventana sin retoque"></td>
</tr></table>
...
### 8. Restauración de una pintura de águilas a tinta

Reconstrucción de papel y pincelada dañados conservando antigüedad, composición y ritmo de tinta.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Restauración de una pintura de águilas a tinta"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Restauración de una pintura de águilas a tinta"></td>
</tr></table>
...
### 9. Serie de carteles culturales en tres idiomas

Un sistema común que pone a prueba la tipografía nativa japonesa, coreana y española.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Serie de carteles culturales en tres idiomas"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Serie de carteles culturales en tres idiomas"></td>
</tr></table>
...
### 10. Sala de control para comercio en directo

Una interfaz de producción que organiza vídeo, productos, moderación, inventario y rendimiento con lógica operativa.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Sala de control para comercio en directo"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Sala de control para comercio en directo"></td>
</tr></table>
...
### 11. De fotografía de insecto a lámina científica

Edición que conserva el espécimen y añade taxonomía, anatomía, ampliaciones y escala sin inventar datos.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="De fotografía de insecto a lámina científica"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="De fotografía de insecto a lámina científica"></td>
</tr></table>
...
### 12. Emisión de historia del arte entre épocas

Escena educativa que combina conocimiento histórico, interfaz contemporánea y una indicación clara de ficción.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Emisión de historia del arte entre épocas"></td>
</tr></table>
...
### 13. Manga monocromo de dos viñetas con diálogo japonés exacto

Reconstrucción de producción basada en un caso comunitario para probar continuidad, dibujo contenido, texto vertical y bocadillos precisos.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Manga monocromo de dos viñetas con diálogo japonés exacto"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Manga monocromo de dos viñetas con diálogo japonés exacto"></td>
</tr></table>

#### Evidencia de la fuente

- **Creador:** [Yasun](https://x.com/yasun_ai)
...
### 18. Edición de identidad de una estrella de rock rebelde

Un caso respaldado por fuentes que explora «Edición de identidad de una estrella de rock rebelde», con instrucciones reutilizables y medios de resultado verificables.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vClvW4AA8M-H.jpg" width="100%" alt="Edición de identidad de una estrella de rock rebelde"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vDMGWoAAHCnh.jpg" width="100%" alt="Edición de identidad de una estrella de rock rebelde"></td>
</tr></table>

#### Evidencia de la fuente

- **Creador:** [Ash](https://x.com/asheem01)
- **Demostración oficial:** [Qwen Image 3.0](https://x.com/asheem01/status/2079940712322199938)
- **Publicado:** 2026-07-22
- **Categoría:** Edición y restauración con referencias
- **Requiere imágenes de referencia:** Sí
...
### 19. Retrato de inspiración Song con tinta refinada y luz fotográfica

Un retrato de Qwen Image 3 basado en una fuente que combina composición inspirada en la dinastía Song, caligrafía legible, textura de seda y color editorial sobrio.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN1YAvkagAAoW3N.jpg" width="100%" alt="Retrato de inspiración Song con tinta refinada y luz fotográfica"></td>
</tr></table>

#### Evidencia de la fuente

- **Creador:** [岚叔](https://x.com/LufzzLiz)
- **Demostración oficial:** [Qwen Image 3.0](https://x.com/LufzzLiz/status/2079925505634234856)
- **Publicado:** 2026-07-22
- **Categoría:** Edición y restauración con referencias
- **Requiere imágenes de referencia:** No
...
Envía solo casos que identifiquen Qwen Image 3.0, incluyan un prompt reutilizable, conserven la fuente canónica y muestren un resultado verificable.

[Enviar un prompt verificado](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Licencia y atribución

El código, las reconstrucciones de prompts, las traducciones y los textos editoriales de ImagineVid se publican bajo CC BY 4.0. Los ejemplos y medios oficiales de Qwen pertenecen a sus titulares y enlazan al anuncio original. Qwen y Alibaba son marcas de sus propietarios. Esta colección independiente no está afiliada ni respaldada por ellos.

Selección de Rowan Hale para ImagineVid.
