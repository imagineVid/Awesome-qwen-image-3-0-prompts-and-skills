...
> Qwen Image 3.0 resmi örnekleri, doğrulanabilir medya ve açık kaynak gösterimiyle yeniden kullanılabilir İngilizce üretim promptlarına dönüştürüldü.
...
- [Model rehberi](#model-guide)
- [İş akışı dizini](#workflow-index)
- [Doğrulanmış resmi örnekler](#verified-showcase-cases)
- [Katkıda bulun](#contribute)
- [Lisans ve atıf](#license-and-attribution)

<a id="model-guide"></a>

## Model rehberi

Qwen Image 3.0, Qwen ekibinin üçüncü nesil görsel üretim ve düzenleme modelidir. Resmi lansman modeli zengin içerik, gerçekçi ayrıntılar ve derin bilgi eksenlerinde tanımlar. Qwen; 4,5K tokene kadar talimat, 10 piksellik metin, 12 dilde yerel işleme, 100'den fazla sanat stili, karmaşık arayüzler ve referanslı düzenleme desteği bildirmektedir. Bu koleksiyon resmi örnekleri eksiksiz İngilizce üretim promptlarına dönüştürür ve bu özellikleri bağımsız sonuçlar yerine üretici beyanı olarak sunar.

> Tüm dillerin aynı yeniden üretilebilir sürümü kullanması için prompt gövdeleri İngilizce tutulur.

### Bu koleksiyon neyi sınar

- Yoğun çok panelli yayınlar ve uzun yapılandırılmış talimatlar
- Küçük metin, formüller, notlar ve çok dilli tipografi
- Cilt, saç, kâğıt, kumaş ve malzemelerde gerçekçi doku
- Referanslı düzenleme, restorasyon, arayüz simülasyonu ve bilgi grafikleri
...
**[ImagineVid'de görsel oluştur](https://imaginevid.io/tr/ai-image-generator)**

<a id="workflow-index"></a>

## İş akışı dizini

- **Uzun biçimli bilgi tasarımı**
- **Tipografi ve yayıncılık**
- **Arayüzler ve dünya bilgisi**
- **Fotogerçekçilik ve malzeme ayrıntısı**
- **Referanslı düzenleme ve restorasyon**
...
### 1. Tek üretimde dokuz alanlık bilgi atlası

Uzun talimatları, anlam ayrımını, formülleri, diyagramları ve okunaklı iki dilli metni sınayan 3×3 eğitim atlası.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update2.png" width="100%" alt="Tek üretimde dokuz alanlık bilgi atlası"></td>
</tr></table>

#### Kaynak kanıtı

- **Üretici:** [Qwen Team](https://qwen.ai/)
- **Resmi gösterim:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Yayın tarihi:** 2026-07-21
- **Kategori:** Uzun biçimli bilgi tasarımı
...
### 2. İç içe yazılım arayüzleri

Dört tanınabilir çalışma alanını hiyerarşiyi koruyan tek bir resim-içinde-resim düzeninde birleştirir.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/3fa25ce8ca621bc3642b431d6724ecc3.png" width="100%" alt="İç içe yazılım arayüzleri"></td>
</tr></table>
...
- **Resmi gösterim:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Yayın tarihi:** 2026-07-21
- **Kategori:** Arayüzler ve dünya bilgisi
- **Referans görsel gerekli:** Hayır
...
### 3. Balina köpekbalığı araştırma rehberi

Anatomi, göç, ölçek, beslenme ve korumayı açık bir hiyerarşide birleştiren yoğun deniz biyolojisi grafiği.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/whale.jpg" width="100%" alt="Balina köpekbalığı araştırma rehberi"></td>
</tr></table>
...
### 4. Hassas dizilmiş cebirsel geometri makalesi

Matematiksel yapı, LaTeX benzeri gösterim, teorem hiyerarşisi ve küçük yazı için yayın testi.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/cca131fe-4ba1-409e-9da0-2358ee2bbb41.png" width="100%" alt="Hassas dizilmiş cebirsel geometri makalesi"></td>
</tr></table>
...
### 5. Pazar gazetesi ön sayfası

Uzun metin, fotoğraf, sütun, açıklama ve gerçekçi kâğıt dokusunu bir araya getiren baskı düzeni.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update5.png" width="100%" alt="Pazar gazetesi ön sayfası"></td>
</tr></table>
...
### 6. Doğal el yazısı çalışma notları

Sayfa, basılı metin, ışık ve perspektifi koruyarak inandırıcı öğrenci notları ekleyen referans düzenlemesi.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update6.jpeg" width="100%" alt="Doğal el yazısı çalışma notları"></td>
<td width="50%"><img src="public/images/qwen-handwritten-annotations-result.png" width="100%" alt="Doğal el yazısı çalışma notları"></td>
</tr></table>
...
### 7. Rötuşsuz pencere portresi

Gözenekler, ince tüyler, nemli gözler, ölçülü renk ve gerçekçi optiğe odaklanan editoryal portre.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/people31_seed9999.png" width="100%" alt="Rötuşsuz pencere portresi"></td>
<td width="50%"><img src="public/images/qwen-window-light-portrait-detail.png" width="100%" alt="Rötuşsuz pencere portresi"></td>
</tr></table>
...
- **Resmi gösterim:** [Qwen Image 3.0](https://qwen.ai/blog?id=qwen-image-3.0)
- **Yayın tarihi:** 2026-07-21
- **Kategori:** Fotogerçekçilik ve malzeme ayrıntısı
- **Referans görsel gerekli:** Hayır
...
### 8. Mürekkepli kartal resminin koruma restorasyonu

Yaş, kompozisyon ve fırça ritmini koruyarak hasarlı kâğıt ve çizgileri onarır.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/0d876cb1-4ed6-4950-9f5c-e5aae886e4e5.png" width="100%" alt="Mürekkepli kartal resminin koruma restorasyonu"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/ab2969ca-90dc-48a8-ae6b-4ef7f01c56a3.png" width="100%" alt="Mürekkepli kartal resminin koruma restorasyonu"></td>
</tr></table>
...
### 9. Üç dilli kültür afişi serisi

Ortak kimlik içinde Japonca, Korece ve İspanyolca doğal tipografiyi sınar.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/iwEdAqNwbmcDAQTRBoAF0QnABrDQDrHWHy7VXwoxvRc_1ZIAB9MAAAABHxSFlwgACaJpbQoAC9IABSUu.png" width="100%" alt="Üç dilli kültür afişi serisi"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/mlp.png" width="100%" alt="Üç dilli kültür afişi serisi"></td>
</tr></table>
...
### 10. Canlı ticaret prodüksiyon masası

Video, ürün, moderasyon, stok ve performansı gerçek iş öncelikleriyle düzenleyen arayüz.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003739.706.png" width="100%" alt="Canlı ticaret prodüksiyon masası"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/image%20-%202026-07-21T003745.645.png" width="100%" alt="Canlı ticaret prodüksiyon masası"></td>
</tr></table>
...
### 11. Böcek fotoğrafından araştırma levhasına

Örneği koruyup taksonomi, anatomi, büyütülmüş ayrıntılar ve ölçek ekleyen bilimsel düzenleme.
...
<table><tr>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/c8fef88f-9379-4826-9860-af1b4d2f6f00.png" width="100%" alt="Böcek fotoğrafından araştırma levhasına"></td>
<td width="50%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/update4.png" width="100%" alt="Böcek fotoğrafından araştırma levhasına"></td>
</tr></table>
...
### 12. Dönemler arası sanat tarihi yayını

Tarihsel bilgiyi, modern arayüzü ve açık kurgu etiketini birleştiren eğitim sahnesi.
...
<table><tr>
<td width="100%"><img src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-Image/image3/case_06.png" width="100%" alt="Dönemler arası sanat tarihi yayını"></td>
</tr></table>
...
### 13. Kesin Japonca diyaloglu iki panelli siyah-beyaz manga

Panel sürekliliği, ölçülü çizgi, dikey Japonca ve doğru konuşma balonlarını sınayan topluluk kanıtlı prodüksiyon yeniden kurgusu.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv679EbwAAW6Ou.jpg" width="100%" alt="Kesin Japonca diyaloglu iki panelli siyah-beyaz manga"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HNv68WbaEAAKITj.jpg" width="100%" alt="Kesin Japonca diyaloglu iki panelli siyah-beyaz manga"></td>
</tr></table>

#### Kaynak kanıtı

- **Üretici:** [Yasun](https://x.com/yasun_ai)
- **Resmi gösterim:** [Qwen Image 3.0](https://x.com/yasun_ai/status/2079531572919996636)
- **Yayın tarihi:** 2026-07-21
- **Kategori:** Tipografi ve yayıncılık
- **Referans görsel gerekli:** Hayır
...
### 14. Tek bir ışık huzmesine doğru sualtı yükselişi

Sualtı kumaşı, inandırıcı anatomi, parçacık derinliği, negatif alan ve uzanan ellere odaklanan topluluk çıktısı rekonstrüksiyonu.
...
<table><tr>
<td width="100%"><img src="https://pbs.twimg.com/media/HN0jqoUaQAAfC8i.jpg" width="100%" alt="Tek bir ışık huzmesine doğru sualtı yükselişi"></td>
</tr></table>

#### Kaynak kanıtı

- **Üretici:** [Zidan](https://x.com/liluocheng13)
- **Resmi gösterim:** [Qwen Image 3.0](https://x.com/liluocheng13/status/2079857838676209967)
...
### 15. Ic ice kod editoru ve sohbet posteri is akisi

Okunabilir arayuz metni, mekansal derinlik ve sohbet icinde poster uretimini test eden katmanli UI istemi.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-ydubbcAAPs_n.png" width="100%" alt="Ic ice kod editoru ve sohbet posteri is akisi"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN-yelfakAAjQN9.png" width="100%" alt="Ic ice kod editoru ve sohbet posteri is akisi"></td>
</tr></table>

#### Kaynak kanıtı

- **Üretici:** [比特小师妹｜KiKi](https://x.com/bit_sister)
- **Resmi gösterim:** [Qwen Image 3.0](https://x.com/bit_sister/status/2080577815376957798)
...
### 16. Yagmurlu Istanbul sokagi metin testi

Turkce harfleri, el yazisini, islak yuzey yansimalarini, dogal kalabaligi ve gercekci anatomiyi olcen cok dilli sokak sahnesi istemi.
...
<table><tr>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rO4cX0AAR78e.jpg" width="100%" alt="Yagmurlu Istanbul sokagi metin testi"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rP9RWAAAst62.jpg" width="100%" alt="Yagmurlu Istanbul sokagi metin testi"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rQ5tW0AAaIuX.jpg" width="100%" alt="Yagmurlu Istanbul sokagi metin testi"></td>
<td width="25%"><img src="https://pbs.twimg.com/media/HN5rRfiW4AA_Eje.jpg" width="100%" alt="Yagmurlu Istanbul sokagi metin testi"></td>
</tr></table>

#### Kaynak kanıtı

- **Üretici:** [Ozan Sihay](https://x.com/ozansihay)
- **Resmi gösterim:** [Qwen Image 3.0](https://x.com/ozansihay/status/2080218385607008613)
- **Yayın tarihi:** 2026-07-23
- **Kategori:** Fotogerçekçilik ve malzeme ayrıntısı
- **Referans görsel gerekli:** Hayır
...
### 17. Vintage coquette referans portresi

Kimlik koruma, gercekci cilt dokusu, eski gul tonu stil ve yakin editorial kadraja odaklanan referansli portre istemi.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5YtbNaYAAOIFV.jpg" width="100%" alt="Vintage coquette referans portresi"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN5Yum6bAAAIApb.jpg" width="100%" alt="Vintage coquette referans portresi"></td>
</tr></table>

#### Kaynak kanıtı

- **Üretici:** [Rich · Atom Tan Studio](https://x.com/atomtanstudio)
- **Resmi gösterim:** [Qwen Image 3.0](https://x.com/atomtanstudio/status/2080197723429711958)
- **Yayın tarihi:** 2026-07-23
- **Kategori:** Fotogerçekçilik ve malzeme ayrıntısı
- **Referans görsel gerekli:** Evet
...
### 18. Asi bir rock yıldızına kimlik düzenlemesi

“Asi bir rock yıldızına kimlik düzenlemesi” konusunu yeniden kullanılabilir talimatlar ve doğrulanabilir sonuç medyasıyla ele alan kaynaklı bir vaka.
...
<table><tr>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vClvW4AA8M-H.jpg" width="100%" alt="Asi bir rock yıldızına kimlik düzenlemesi"></td>
<td width="50%"><img src="https://pbs.twimg.com/media/HN1vDMGWoAAHCnh.jpg" width="100%" alt="Asi bir rock yıldızına kimlik düzenlemesi"></td>
</tr></table>

#### Kaynak kanıtı

- **Üretici:** [Ash](https://x.com/asheem01)
- **Resmi gösterim:** [Qwen Image 3.0](https://x.com/asheem01/status/2079940712322199938)
- **Yayın tarihi:** 2026-07-22
- **Kategori:** Referanslı düzenleme ve restorasyon
- **Referans görsel gerekli:** Evet
...
Yalnızca Qwen Image 3.0'ı açıkça belirten, yeniden kullanılabilir prompt, özgün kaynak ve incelenebilir sonuç içeren örnekleri gönderin.

[Doğrulanmış prompt gönder](https://github.com/imagineVid/Awesome-qwen-image-3-0-prompts-and-skills/issues/new?template=submit-prompt.yml)

<a id="license-and-attribution"></a>

## Lisans ve atıf

ImagineVid tarafından yazılan kod, prompt yeniden kurguları, çeviriler ve editoryal metinler CC BY 4.0 kapsamındadır. Qwen'in resmi örnekleri ve medyası hak sahiplerine aittir ve özgün duyuruya bağlanır. Qwen ve Alibaba sahiplerinin ticari markalarıdır. Bu bağımsız koleksiyon onlarla bağlantılı değildir veya onlar tarafından desteklenmez.

ImagineVid için Rowan Hale tarafından derlendi.
